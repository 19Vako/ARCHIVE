        ...
        <div className="deleteModalManagerContainer">
          ...
          <div className="deleteModalManagerButtons">
            ...
            <button
              ...
              onClick={() => setDeleteManagerModal(false)}
            >
              Відмінити
            </button>
          </div>
    ...
    <div className="addManagercontainer">
      <div className="managerList">
        <div className="filter">
          ...
          <input
            value={findName}
            onChange={(name) => {
              setFindName(name.target.value);
              FindManager();
            }}
            className="filterInput"
            placeholder="Пошук менеджера"
          />
          <img
            onClick={() => {
              CleanInput();
            }}
            className="inputButtonClean"
            src={require("../icons/letter-x.png")}
            alt=""
          />
        </div>
        <div className="list">
      ...
      <div className="addManagerForm">
        <div className="addForm">
          ...
          <h1
            className="logs"
            style={logError ? { color: "red" } : { color: "green" }}
          >
            {log}
          </h1>
          <button onClick={() => AddManager()} className="addButton">
            Додати
          </button>
        </div>
        {showManager ? (
          <div className="managerOptions">
            ...
            <div className="managerOptionsContainer">
              ...
              <div className="optionButtons">
                <button onClick={() => ChangeManager()} className="saveButton">
                  Зберегти
                </button>
                <button
